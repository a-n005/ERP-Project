...
namespace Acc_Trede_winForms_Test.DAL
{
    public class clsSalesInvoicesTest
    {
        ...
        public static IEnumerable<object[]> GetSalesInvoiceTestData()
        {
            ...
            DataTable dt1 = InitializeCartTable(1, 5, 10);   // valid product
            DataTable dt2 = InitializeCartTable(1, 5, 10);  // invalid product name 
            DataTable dt3 = InitializeCartTable(1, 5, 10); // new barcode
            DataTable dt4 = InitializeCartTable(1, 10, 10); // new barcode
            DataTable dt5 = InitializeCartTable(1, 10, 15); // new barcode
            dt5.Rows.Add(1, 10, 15);

            // كل سطر هنا يمثل حالة فحص كاملة (تطابق بارامترات دالة التست)
            yield return new object[] { "5", 1, 1, "Cash", 50.0m, 0.0m, 0.0m, 50.0m, 50.0m, 0.0m, dt1 };
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
            yield return new object[] { "6", 1, null, "Card", 50.0m, 0.0m, 0.0m, 50.0m, 0m, 50.0m, dt2 };
            yield return new object[] { "7", 1, 2, "Credit", 50.0m, 5.0m, 1.0m, 46.0m, 50.0m, 50.0m, dt3 };
            yield return new object[] { "8", 1, 4, "Mixed", 100.0m, 10.0m, 15.0m, 105.0m, 50.0m, 50.0m, dt4 };
            yield return new object[] { "9", 1, null, "Mixed", 300.0m, 50.0m, 20.0m, 270.0m, 135.0m, 135m, dt5 };
#pragma warning restore CS8625 
        ...
        public void InsertSalesInvoice_Multiple_Success(
         string invoiceNumber, int userID, int? customerID, string paymentType,
        ...
        {
            var x = clsSalesInvoices_DAL.InsertSalesInvoice(invoiceNumber, userID, customerID, paymentType,
        ...
        public static IEnumerable<object[]> GetSalesInvoiceTestData1()
        {
            ...
            // كل سطر هنا يمثل حالة فحص كاملة (تطابق بارامترات دالة التست)
            yield return new object[] { "s", 1, 1, "Cash", 50.0m, 0.0m, 0.0m, 50.0m, 50.0m, 0.0m, dt1 };
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
            yield return new object[] { "12", 1, null, "Cash", 50.0m, 0.0m, 0.0m, 50.0m, 5.0m, 0.0m, dt1 };// has credit, null suppid
            yield return new object[] { null, 1, null, "Card", 50.0m, 0.0m, 0.0m, 50.0m, 50.0m, 0.0m, dt2 };// invalid invoice num
            yield return new object[] { "14", null, 2, "Credit", 50.0m, 5.0m, 1.0m, 46.0m, 50.0m, 50.0m, dt3 };// invalid userid
            yield return new object[] { "15", 1, 4, "Mixed", 100.0m, 10.0m, 15.0m, 105.0m, 1000.0m, 50.0m, dt4 };
            yield return new object[] { "35", 1, null, "Mixed", 300.0m, 50.0m, 20.0m, 270.0m, 1035.0m, 135m, dt5 };
#pragma warning restore CS8625 
